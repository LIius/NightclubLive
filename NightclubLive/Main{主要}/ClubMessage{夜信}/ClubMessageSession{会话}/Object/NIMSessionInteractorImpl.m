...
@interface NIMSessionInteractorImpl()<NIMChatManagerDelegate,NIMConversationManagerDelegate>
...
{
    message.apnsPayload = @{@"fromUser":[[NIMSDK sharedSDK].loginManager currentAccount]};
...
- (void)mediaLocationPressed{
    ...
    [self.mediaFetcher fetchLocaton:^(CGFloat latitude, CGFloat longitude, NSString *name) {
        
        NIMLocationObject *locationMsg = [[NIMLocationObject alloc] initWithLatitude:latitude longitude:longitude title:name];
        
        NIMMessage *message = [[NIMMessage alloc] init];
        message.messageObject = locationMsg;
