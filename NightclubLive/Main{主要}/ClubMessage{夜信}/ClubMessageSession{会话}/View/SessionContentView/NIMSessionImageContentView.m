...
- (void)layoutSubviews{
  ...
  //  UIEdgeInsets contentInsets = self.model.contentViewInsets;
    ...
    CGRect imageViewFrame = CGRectMake((self.width - contentSize.width) * 0.5, (self.height - contentSize.height) * 0.5, contentSize.width, contentSize.height);
...
- (void)onTouchUpInside:(id)sender
{
    ...
    event.eventName = NIMKitEventImage;
