...
- (NSArray *)defaultMediaItems
{
    return @[
             [NIMMediaItem item:@"onTapMediaItemPicture:"
                                  normalImage:[UIImage imageNamed:@"icon_picture"]
                                selectedImage:[UIImage imageNamed:@"icon_picture"]
                                        title:@"相册"],
             [NIMMediaItem item:@"onTapMediaItemShoot:"
                    normalImage:[UIImage imageNamed:@"icon_camera"]
                  selectedImage:[UIImage imageNamed:@"icon_camera"]
                          title:@"拍照"],
             
             [NIMMediaItem item:@"onTapMediaItemLocation:"
                    normalImage:[UIImage imageNamed:@"icon_chatposition"]
                  selectedImage:[UIImage imageNamed:@"icon_chatposition"]
                          title:@"位置"],
             [NIMMediaItem item:@"onTapItemGift:"
                    normalImage:[UIImage imageNamed:@"icon_chatpresent"]
                  selectedImage:[UIImage imageNamed:@"icon_chatpresent"]
                          title:@"礼物"],
             ];
}
