...
- (void)setAvatarBySession:(NIMSession *)session
{
    ...
    if ([session.sessionId isEqualToString:@"礼物管家"]){
        [self nim_setImageWithURL:nil placeholderImage:KGetImage(@"icon_liwuguanjiasmall")];
    }
    else if ([session.sessionId isEqualToString:@"评论"]){
        [self nim_setImageWithURL:nil placeholderImage:KGetImage(@"icon_pingluntixing")];
    }
    else{
...
- (void)setAvatarByMessage:(NIMMessage *)message
{
    ...
    if ([message.from isEqualToString:@"礼物管家"]){
