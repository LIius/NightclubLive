...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (IOS_VERSION < 8.0) {
        ...
        childVC.view.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - 100);
...
#warning iPhoneX
    ...
    if (iPhoneX)
    {
        rect = CGRectMake(0.0, -24,SCREEN_WIDTH, SCREEN_HEIGHT -134);
    }else{
        rect = CGRectMake(0.0, 0,SCREEN_WIDTH, SCREEN_HEIGHT -100);
    }
