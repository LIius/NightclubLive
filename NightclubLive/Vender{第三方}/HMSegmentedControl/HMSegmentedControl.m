    ...
    if (self.type == HMSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            if (self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleFixed) {
                ...
                CGFloat div_height;
                CGFloat div_Y;
                if (self.verticalDividerHeight>0&&self.verticalDividerHeight<=self.frame.size.height - self.selectionIndicatorHeight * 4) {
                    div_height = self.verticalDividerHeight;
                    div_Y = (self.frame.size.height - self.selectionIndicatorHeight * 4 - div_height)/2+self.selectionIndicatorHeight * 2;
                }else
                {
                    div_Y = self.selectionIndicatorHeight * 2;
                    div_height = self.frame.size.height - (self.selectionIndicatorHeight * 4);
                }
                rectDiv = CGRectMake((self.segmentWidth * idx) - (self.verticalDividerWidth / 2), div_Y, self.verticalDividerWidth, div_height);
                ...
                rectDiv = CGRectMake(xOffset - (self.verticalDividerWidth / 2), div_Y, self.verticalDividerWidth, div_height);
...
//                rectDiv = CGRectMake(xOffset - (self.verticalDividerWidth / 2), self.selectionIndicatorHeight * 2, self.verticalDividerWidth, self.frame.size.height - (self.selectionIndicatorHeight * 4));
        ...
        [self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            ...
            if (self.isVerticalDividerEnabled && idx>0) {
                ...
                verticalDividerLayer.frame = CGRectMake((self.segmentWidth * idx) - (self.verticalDividerWidth / 2), div_Y, self.verticalDividerWidth, div_height);
