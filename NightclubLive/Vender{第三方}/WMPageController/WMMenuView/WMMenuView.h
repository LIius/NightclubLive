...
typedef NS_ENUM(NSUInteger, WMMenuViewStyle) {
    ...
    WMMenuViewStyleVerticalLine,    // 竖线{包含下划线}
    WMMenuViewStyleVerticalLineBottomLine,    // 竖线{包含下划线+包含底部横线}
};
...
// {coderiding，如果是显示三角形样式，那就是只三角形的高；如果是其他样式，指的是内部文字覆盖progress的高度，原本是0.8，现在改成1.0}
