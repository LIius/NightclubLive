...
/// 定制进度条，若每个进度条长度相同，可设置该属性{如果不设置，会返回items的宽度作为progressview的宽度，具体查看convertProgressWidthsToFrames方法}
...
/// 竖线偏移Y值{coderiding}
@property (nonatomic, assign) CGFloat verticalLineOffY;


/// 竖线颜色{coderiding}
@property (nonatomic, nullable, strong) UIColor *verticalLineColor;

/// 底部横线颜色{coderiding}
@property (nonatomic, nullable, strong) UIColor *bottomLineColor;
...
//{coderiding，menu的radius}
@property (nonatomic, assign) CGFloat menuCornerRadius;
//{coderiding，menu的scrollviewcolor}
@property (nonatomic, strong) UIColor *menuScrollviewColor;
/** 顶部导航栏 */
